...
const apartments: ApartmentType[] = [
  {
    type: "Type C1",
    surface: "128,76 m²",
    config: "4 chambres, 2 salons, 3 toilettes",
    features: [
      "Claire division fonctionnelle",
      "Lumière naturelle et ventilation optimisées",
      "Espaces communs spacieux",
      "Design adapté au climat tropical",
      "Balcon cuisine et balcon salon",
    ],
    price: "À partir de 11,76 millions GNF mensuels",
  ...
  },
  {
    ...
    price: "À partir de 10,56 millions GNF mensuels",
    image: "/images/apartments/f3-appartement.jpg",
  },
];
      ...
      <section className="py-24 bg-[#1f2d3d]">
        <div className="max-w-[1100px] mx-auto px-6 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6 uppercase tracking-wide font-[Roboto_Condensed]">
            Intéressé par un appartement F5 ?
          </h2>
