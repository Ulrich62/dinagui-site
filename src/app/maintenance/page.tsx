...
export const metadata: Metadata = {
  ...
  description:
    "Notre site est en cours de maintenance. Nous serons bientôt de retour.",
};
      ...
      <div className="max-w-lg w-full text-center">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-left space-y-3">
          ...
          <div className="flex items-center gap-3 text-white/70 text-sm">
            <svg
              className="w-4 h-4 text-[#F88732] shrink-0"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <p className="text-white/30 text-xs mt-8">
          &copy; {new Date().getFullYear()} DINAGUI SARL — Un choix sûr et
          durable
        </p>
      </div>
    </div>
