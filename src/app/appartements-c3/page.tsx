...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Appartements Type C3 — DINAGUI SARL",
    description:
      "Appartements Type C3 (83,11 m²) à la Cité Plaza Platinium, Kipé, Conakry.",
    url: "/appartements-c3",
    locale: "fr_GN",
    type: "website",
    images: [
      {
        url: "/images/plaza-platinium/brochure-13.jpg",
        width: 1200,
        height: 630,
        alt: "Plan Type C3 — Plaza Platinium",
      },
    ],
  },
};
...
const apartments: ApartmentType[] = [
  {
    ...
    surface: "83,11 m²",
    config:
      "2 chambres, 2 toilettes, salon + salle à manger, cuisine, 2 balcons",
    features: [
...
const schemaApartment = apartmentListing({
  ...
  description:
    "Appartement Type C3 à la Cité Plaza Platinium, Kipé, Conakry. 2 chambres, 83,11 m².",
...
export default function AppartementsC3Page() {
  return (
    <>
      ...
      />
      <PageHero
        title="Appartements Type C3"
        subtitle="2 chambres · 83,11 m² · Cité Plaza Platinium, Kipé"
      />
      <OfferVideoSection
        title="Découvrez l'appartement C3 en vidéo"
      ...
      <section className="py-24 bg-[#1f2d3d]">
        <div className="max-w-[1100px] mx-auto px-6 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6 uppercase tracking-wide font-[Roboto_Condensed]">
            Intéressé par un appartement C3 ?
          </h2>
