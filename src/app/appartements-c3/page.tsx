...
export const metadata: Metadata = {
  title: "Appartements Type C3 — DINAGUI SARL",
  description:
    "Appartements Type C3 à la Cité Plaza Platinium, Immeuble 5, Kipé, Conakry. 2 chambres, 83,11 m², aménagement intérieur optimisé.",
  alternates: { canonical: "/appartements-c3" },
  openGraph: {
    title: "Appartements Type C3 — DINAGUI SARL",
    description: "Appartements Type C3 (83,11 m²) à la Cité Plaza Platinium, Kipé, Conakry.",
    url: "/appartements-c3",
    locale: "fr_GN",
    type: "website",
    images: [{ url: "/images/plaza-platinium/brochure-13.jpg", width: 1200, height: 630, alt: "Plan Type C3 — Plaza Platinium" }],
  },
};
...
const apartments: ApartmentType[] = [
  {
    type: "Type C3",
    surface: "83,11 m²",
    config: "2 chambres, 2 toilettes, salon + salle à manger, cuisine, 2 balcons",
    features: [
      "Chambre principale de 14,81 m² avec toilette de 6,45 m²",
      "Chambre de 12,50 m² avec toilette de 6,90 m²",
      "Salon + salle à manger de 24,50 m²",
      "Cuisine de 9,30 m²",
      "Balcon 1 de 3,60 m²",
      "Balcon 2 de 5,05 m²",
    ],
    image: "/images/plaza-platinium/brochure-13.jpg",
  },
  {
    type: "Type C3' (variante symétrique)",
    surface: "83,11 m²",
    config: "2 chambres, 2 toilettes, salon + salle à manger, cuisine, 2 balcons",
    features: [
      "Plan symétrique du Type C3",
      "Mêmes surfaces et agencement optimisé",
      "Chambre principale de 14,81 m²",
      "Salon + salle à manger de 24,50 m²",
      "Cuisine de 9,30 m²",
      "Double balcon (3,60 + 5,05 m²)",
    ],
    image: "/images/plaza-platinium/brochure-14.jpg",
  },
];

const schemaApartment = apartmentListing({
  name: "Appartement Type C3 — Cité Plaza Platinium",
  description: "Appartement Type C3 à la Cité Plaza Platinium, Kipé, Conakry. 2 chambres, 83,11 m².",
  path: "/appartements-c3",
  image: "/images/plaza-platinium/brochure-13.jpg",
  numberOfRooms: 2,
  floorSize: { min: 83, max: 84 },
  typologies: [
    { type: "Type C3", surface: "83,11 m²", price: "" },
    { type: "Type C3'", surface: "83,11 m²", price: "" },
  ],
});
...
const schemaBreadcrumb = breadcrumbList([
  { name: "Accueil", path: "/" },
  { name: "Appartements Type C3", path: "/appartements-c3" },
]);

export default function AppartementsC3Page() {
  return (
    <>
      ...
      <PageHero title="Appartements Type C3" subtitle="2 chambres · 83,11 m² · Cité Plaza Platinium, Immeuble 5" />
      <OfferVideoSection title="Découvrez l'appartement C3 en vidéo" subtitle="Visite guidée des espaces, des finitions et du cadre de vie." videoSrc="/videos/nos-offres-intro.mp4" poster="/images/plaza-platinium/brochure-13.jpg" background="white" />
